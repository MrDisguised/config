...
# Script taken from Khlam debloater https://github.com/khlam/debloat-samsung-android
...
adb shell pm uninstall --user 0 com.flipboard.app
adb shell pm uninstall --user 0 com.flipboard.boxer.app
...
adb shell pm uninstall --user 0 com.tv.peel.samsung.app
...
# com.samsung.android.lool is the samsung device care app managed by Qihoo 360 antivirus company which sends data to chinese companies over HTTPS
adb shell pm uninstall --user 0 com.samsung.android.bixby.wakeup
adb shell pm uninstall --user 0 com.samsung.android.bixbyvision.framework
adb shell pm uninstall --user 0 com.samsung.android.app.settings.bixby
adb shell pm uninstall --user 0 com.samsung.android.bixby.agent
...
adb shell pm uninstall --user 0 com.android.forest
...
# PACKAGES THAT U SHOULDN'T UNINSTALL !!!!!!!!

#1. adb shell pm uninstall --user 0 com.android.settings.intelligence
#A) Removing the above package remove the search functionality/ search icon in the settings app.
#2. adb shell pm uninstall --user 0 com.samsung.android.app.galaxyfinder
#A) Uninstalling com.samsung.android.app.galaxyfinder will disable ur app search functionality u can restore it with adb shell pm install-existing --user 0 com.samsung.android.app.galaxyfinder
